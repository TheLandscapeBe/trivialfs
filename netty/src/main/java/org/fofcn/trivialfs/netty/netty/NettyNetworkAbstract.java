...
import org.fofcn.trivialfs.netty.common.Pair;
import org.fofcn.trivialfs.netty.common.ServiceThread;
import org.fofcn.trivialfs.netty.enums.ResponseCode;
import org.fofcn.trivialfs.netty.exception.NetworkConnectException;
import org.fofcn.trivialfs.netty.exception.NetworkRequestNotMatchedException;
...
import org.fofcn.trivialfs.netty.util.NetworkUtil;
...
public abstract class NettyNetworkAbstract {
    ...
    protected final List<RequestInterceptor> interceptors = new ArrayList<>(10);
